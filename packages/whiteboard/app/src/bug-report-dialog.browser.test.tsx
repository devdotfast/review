...
describe("BugReportControl", () => {
  ...
  beforeEach(() => {
    ...
    session = testWhiteboardSession({}, { request });
  ...
  it.each([200, 500])(
    ...
    async (status) => {
      ...
      expect(container.querySelector(".whiteboard-toast")).toBeNull();
  ...
  async function renderControl(tutorial?: WhiteboardCanvasTutorialBridge) {
    await act(async () => {
      root.render(
...
function tutorialBridge(): WhiteboardCanvasTutorialBridge {
  return {
    content: {
