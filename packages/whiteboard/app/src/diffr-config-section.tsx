...
function summaryDraft(
  config: WhiteboardDiffrConfig,
): WhiteboardDiffrSummarizerInput {
  return {
...
export function DiffrConfigSection({
  ...
  actions: WhiteboardDiffrConfigActions;
  reloadWindow(): Promise<void>;
}) {
  const [opened, setOpened] = useState(false);
  const [config, setConfig] = useState<WhiteboardDiffrConfig>();
  const [draft, setDraft] = useState<WhiteboardDiffrSummarizerInput>();
  ...
  function saved(result: WhiteboardDiffrConfig) {
    setConfig(result);
  ...
  return (
    <div className="whiteboard-settings-diffr">
      <details>
        ...
        {opened && (
          <>
            <p className="whiteboard-settings-row-description">
              ...
              <>
                ...
                {displaySettings.map(([key, label]) => (
                  <div key={key}>
                    ...
                    {setting(config, key) === undefined && (
                      <p className="whiteboard-settings-unavailable">
                ...
                {draft && (
                  <fieldset
                    ...
                    className="whiteboard-settings-summary-fields"
                  >
                    ...
                    <SettingRow label="API key">
                      <input
                        className="whiteboard-settings-input"
                        aria-label="API key"
                        type="password"
                        autoComplete="off"
                    ...
                    <div className="whiteboard-settings-summary-actions">
                      <button
                        type="button"
                ...
                {summary && (
                  <pre
                    className="whiteboard-settings-summary-result"
      ...
      {error && (
        <p role="alert" className="whiteboard-settings-error">
          {error}
        </p>
      )}
      {changed && (
