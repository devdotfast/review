...
import {
	...
	MaximizeGroupHideSidebarAction, ToggleMaximizeEditorGroupAction, MinimizeOtherGroupsHideSidebarAction,
...
appendEditorToolItem(
	...
	ContextKeyExpr.and(SplitEditorsVertically.negate(), IsSessionsWindowContext.toNegated(), IsReviewWindowContext.toNegated()),
	SPLIT_ORDER,
	{
...
appendEditorToolItem(
	...
	ContextKeyExpr.and(SplitEditorsVertically, IsSessionsWindowContext.toNegated(), IsReviewWindowContext.toNegated()),
	SPLIT_ORDER,
	{
