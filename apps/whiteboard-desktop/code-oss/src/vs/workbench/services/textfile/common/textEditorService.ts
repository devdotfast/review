...
import { isWhiteboardReadonlySource } from '../../../../whiteboard/common/whiteboardReadonlySource.js';
import { WhiteboardSourceEditorInput } from '../../../../whiteboard/services/whiteboardSourceEditorInput.js';
	...
	createTextEditor(input: IUntypedEditorInput | IUntypedFileEditorInput): EditorInput | IFileEditorInput {
		...
		if (textResourceEditorInput.resource instanceof URI) {
			...
			return this.createOrGetCached(canonicalResource, () => {
				if (isWhiteboardReadonlySource(canonicalResource)) {
					return this.instantiationService.createInstance(WhiteboardSourceEditorInput, canonicalResource, textResourceEditorInput.label, textResourceEditorInput.description, undefined, undefined);
				}
