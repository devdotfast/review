...
describe("review-agent-traces", () => {
  ...
  it("exports OpenCode sessions and reads them back through legacy bucket storage without hosted login", async () => {
    ...
    const exported = {
      ...
      messages: [
        {
          info: { id: "msg_example", sessionID: sessionId, role: "user" },
          parts: [
            { id: "part_example", type: "text", text: "Check legacy storage" },
          ],
        },
      ],
    };
