...
export interface WhiteboardPickerItem {
  uuid: string;
  title: string;
  status: string;
 ...
 */
export function pickWhiteboard(
  items: readonly WhiteboardPickerItem[],
  io: { stdin: NodeJS.ReadStream; stdout: Writable },
): Promise<WhiteboardPickerItem | null> {
  ...
  return new Promise((resolve, reject) => {
    ...
    const filtered = (): WhiteboardPickerItem[] =>
    ...
    const finish = (result: WhiteboardPickerItem | null) => {
