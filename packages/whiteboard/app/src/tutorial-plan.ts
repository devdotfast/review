import type { TutorialStepId } from "@dev.fast/whiteboard-protocol";
...
const tutorialSteps: readonly TutorialStepDefinition[] = [
  ...
  },
  {
    ...
    targetSelector:
      '[data-whiteboard-section="Welcome"] .whiteboard-inline-editor',
  },
  {
    id: "gotoDefinition",
    chapter: "welcome",
  ...
  },
  {
    ...
    completion: "click",
    targetSelector:
      '[data-whiteboard-section="Welcome"] a[data-whiteboard-anchor-id]',
  },
  {
    id: "openCommits",
    chapter: "commits",
  ...
  },
  {
    ...
    completion: "click",
    targetSelector: ".whiteboard-commit-open",
  },
  {
    id: "openSequence",
    chapter: "diagrams",
    ...
    completion: "external",
    targetSelector:
      '[data-whiteboard-section="Interactive Diagrams"] .sequence-diagram .diagram-tour-button',
  },
  {
    id: "openMap",
    chapter: "diagrams",
  ...
  },
  {
    ...
    completion: "external",
    targetSelector:
      '[data-whiteboard-section="Interactive Diagrams"] .database-lens .diagram-tour-button',
  },
  {
    id: "openTraceQuote",
    chapter: "traces",
    ...
    completion: "click",
    targetSelector:
      '[data-whiteboard-section="Agent traces"] .whiteboard-trace-quote',
  },
  {
    id: "getHelp",
    chapter: "finish",
    ...
    instruction:
      "Use Settings to manage installed Whiteboard skills, or Getting Started to revisit setup and this tour.",
    completion: "finish",
    targetSelector:
      '[data-whiteboard-section="Get help"] .whiteboard-section-body',
  },
];
