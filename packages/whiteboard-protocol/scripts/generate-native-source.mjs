...
// imports as vs/whiteboard/common/whiteboardProtocol.ts. The overlay is every
...
const HEADER = [
  "// GENERATED from @dev.fast/whiteboard-protocol. Do not edit.",
...
const MODULE_PATHS = [
  ...
  path.join(sourceRoot, "whiteboard-api-client.ts"),
