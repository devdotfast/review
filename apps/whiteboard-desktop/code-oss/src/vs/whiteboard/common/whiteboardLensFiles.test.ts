...
import { lensFiles } from './whiteboardLensFiles.js';
import { lensContextGaps } from './whiteboardLens.js';
import type { WhiteboardDiffFileWire, WhiteboardDiffLens } from './whiteboardProtocol.js';

const files: WhiteboardDiffFileWire[] = [{ path: 'renamed.ts', previousPath: 'old.ts', status: 'renamed', additions: 2, deletions: 1 }];
