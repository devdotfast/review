...
export function SettingsSlidersIcon(): ReactElement {
  return (
    <svg
      aria-hidden="true"
      className="whiteboard-debug-trigger-icon"
      focusable="false"
      viewBox="0 0 24 24"
    >
...
export function MarkerUnderline(): ReactElement {
  return (
    <svg
      className="whiteboard-marker-underline"
      viewBox="0 0 48 3"
 ...
 * workbench restyles its codicon twisties to the same path (whiteboard.css).
 */
