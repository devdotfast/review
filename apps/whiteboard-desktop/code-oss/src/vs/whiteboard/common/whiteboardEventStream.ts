...
import { type JsonValue, parseJsonText } from "./whiteboardProtocol.js";

const DEFAULT_MAX_EVENT_CHARACTERS = 1024 * 1024;
const EVENT_BOUNDARY = /(?:\r\n|\r|\n)(?:\r\n|\r|\n)/g;

export interface ConsumeWhiteboardEventStreamOptions {
  readonly maxEventCharacters?: number;
}

export async function consumeWhiteboardEventStream(
  stream: ReadableStream<Uint8Array>,
  onValue: (value: JsonValue) => void | Promise<void>,
  signal: AbortSignal,
  options: ConsumeWhiteboardEventStreamOptions = {},
): Promise<void> {
