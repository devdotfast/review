...
import "./whiteboardExtensionHost.contribution.js";
...
class WhiteboardChatWidgetService implements IChatWidgetService {
	...
	openSession(_sessionResource: URI, _target?: PreferredGroup, _options?: IChatEditorOptions): Promise<undefined>;
...
registerSingleton(IChatWidgetService, WhiteboardChatWidgetService, InstantiationType.Delayed);
...
import "./browser/parts/canvas/whiteboardCanvasEditor.contribution.js";
import "./browser/parts/canvas/whiteboardFind.contribution.js";
import "./browser/whiteboardCommunity.contribution.js";
import "./browser/whiteboardTheme.contribution.js";
import "./contrib/explorer/whiteboardFileTree.contribution.js";
import "./contrib/extensions/whiteboardCuratedExtensions.contribution.js";
import "./contrib/install/whiteboardCliInstall.contribution.js";
import "./contrib/quickaccess/whiteboardQuickAccess.contribution.js";
import "./contrib/settings/whiteboardSettings.contribution.js";
import "./contrib/telemetry/whiteboardLspTelemetry.contribution.js";
import "./contrib/telemetry/whiteboardTelemetry.contribution.js";
...
import { IWhiteboardCanvasPartsService, WhiteboardCanvasParts } from "./browser/parts/canvas/whiteboardCanvasPart.js";
import { IWhiteboardExplorerPartsService, WhiteboardExplorerParts } from "./browser/parts/explorer/whiteboardExplorerPart.js";
import "./browser/whiteboardPaneCompositePartService.js";
import "./common/whiteboardConfiguration.js";
import { IWhiteboardVerbsService, WhiteboardVerbsService } from "./contrib/verbs/whiteboardVerbs.js";
import { IWhiteboardApiCatalogService, WhiteboardApiCatalogService } from "./services/whiteboardApiCatalogService.js";
import { IWhiteboardApiSourceService, WhiteboardApiSourceService } from "./services/whiteboardApiSourceService.js";
import {
	IWhiteboardCanvasEditorTabsService,
	WhiteboardCanvasEditorTabsService,
} from "./services/whiteboardCanvasEditorTabsService.js";
import {
	IWhiteboardDesktopConnectionService,
	WhiteboardDesktopConnectionService,
} from "./services/whiteboardDesktopConnectionService.js";
import { IWhiteboardTelemetryService, WhiteboardTelemetryService } from "./services/whiteboardTelemetryService.js";
import "./services/whiteboardWorkbenchServices.js";
import "./services/whiteboardLocalLanguageFeatures.js";

registerSingleton(IWhiteboardDesktopConnectionService, WhiteboardDesktopConnectionService, InstantiationType.Eager);
registerSingleton(IWhiteboardTelemetryService, WhiteboardTelemetryService, InstantiationType.Delayed);

registerSingleton(IWhiteboardCanvasEditorTabsService, WhiteboardCanvasEditorTabsService, InstantiationType.Delayed);

registerSingleton(IWhiteboardApiSourceService, WhiteboardApiSourceService, InstantiationType.Delayed);
registerSingleton(IWhiteboardApiCatalogService, WhiteboardApiCatalogService, InstantiationType.Delayed);
registerSingleton(IWhiteboardVerbsService, WhiteboardVerbsService, InstantiationType.Delayed);
registerSingleton(IWhiteboardCanvasPartsService, WhiteboardCanvasParts, InstantiationType.Eager);
registerSingleton(IWhiteboardExplorerPartsService, WhiteboardExplorerParts, InstantiationType.Eager);

import "./contrib/sharing/whiteboardSharing.contribution.js";
