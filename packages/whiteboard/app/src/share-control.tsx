...
export function ShareControl() {
  ...
  return (
    <div ref={popover} style={{ position: "relative" }}>
      <button
        type="button"
        className="whiteboard-topbar-icon-button whiteboard-share-button"
        ref={tooltip}
        aria-label={label}
      ...
      {open && (
        <div
          ...
          className="whiteboard-share-popover"
        >
          {(error || accountError || account?.error) && (
            <p className="whiteboard-share-error" role="alert">
              {error ?? accountError ?? account?.error}
            </p>
          )}
          {shared ? (
            <>
              <p className="whiteboard-share-status">{label}</p>
              <p className="whiteboard-share-status">
            ...
            link ? (
              <>
                <input
                  className="whiteboard-share-link"
                ...
                <button
                  type="button"
                  className="whiteboard-share-action"
              ...
              <p className="whiteboard-share-status">Uploading…</p>
            )
          ) : (
            account && (
              <>
