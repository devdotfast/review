...
export interface FixtureWhiteboardApi {
  snapshot: Snapshot;
  progress?: WhiteboardProgress;
 ...
 */
export function fixtureWhiteboardBridge(
  api: FixtureWhiteboardApi,
): WhiteboardCanvasBridge {
