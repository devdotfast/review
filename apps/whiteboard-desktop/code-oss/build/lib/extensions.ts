...
function fromLocal(extensionPath: string, forWeb: boolean, _disableMangle: boolean): Stream {
	...
	// Fallback: check for .esbuild.mts/.esbuild.ts used by extensions with their own build systems.
...
const excludedExtensions = [
	...
	// Review's curated built-ins are prebuilt VSIX payloads, not sources. Packaging
	// them here would run vsce's npm file listing against dependencies they already
	// bundle; apps/whiteboard-desktop/scripts/curated-extensions.mjs stages them into
