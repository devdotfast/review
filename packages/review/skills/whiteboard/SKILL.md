...
you are writing an interactive rfc-style session, for consumption by a staff engineer.

**flow**
- register the repository
- create the session, pinned to the commits/pr the user describes (TODO: working tree?)
...
- session structure - each of these should be written as a top-level `section`, in this order:
...
- before finishing, read the whole session back and fix any contradictions/unverified claims.
