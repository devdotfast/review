...
export function authoringTools() {
  ...
  const descriptions = {
    ...
    feedback:
      "Save or post a comment, reply, resolve a thread, or submit selected drafts. Posted messages are immutable.",
    attention:
      "Mark a review viewed, dismissed or restored without changing its content.",
    delete: "Permanently delete this review, its history and its comments.",
  };
