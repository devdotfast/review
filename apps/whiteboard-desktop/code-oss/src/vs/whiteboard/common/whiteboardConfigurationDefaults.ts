...
export const WHITEBOARD_KEYMAP_SETTING = 'whiteboard.keymap';
export const WHITEBOARD_TELEMETRY_SETTING = 'whiteboard.telemetry.enabled';
export const WHITEBOARD_STRUCTURAL_DIFF_SETTING = 'whiteboard.experimental.structuralDiff.enabled';
export const WHITEBOARD_SOFTWARE_MAP_SETTING = 'whiteboard.experimental.softwareMap.enabled';
export const WHITEBOARD_KEYMAPS = ['none', 'vim', 'emacs'] as const;
export type WhiteboardKeymap = typeof WHITEBOARD_KEYMAPS[number];

export const whiteboardConfigurationDefaults = {
	[WHITEBOARD_SOFTWARE_MAP_SETTING]: false,
	[WHITEBOARD_STRUCTURAL_DIFF_SETTING]: true,
	[WHITEBOARD_TELEMETRY_SETTING]: true,
...
export const whiteboardAgentsWindowDefaultOverrides = {
	'window.title': whiteboardConfigurationDefaults['window.title'],
	'workbench.navigationControl.enabled': whiteboardConfigurationDefaults['workbench.navigationControl.enabled'],
} as const;
