...
export function ClaudeCodeLogo(): ReactElement {
  return (
    <svg
      aria-hidden="true"
      className="whiteboard-agent-logo whiteboard-agent-logo--claude"
      focusable="false"
      viewBox="0 0 24 24"
    >
      <path
...
export function CodexLogo(): ReactElement {
  return (
    <svg
      aria-hidden="true"
      className="whiteboard-agent-logo whiteboard-agent-logo--codex"
      focusable="false"
      viewBox="0 0 24 24"
    >
      <path
...
export function CursorLogo(): ReactElement {
  return (
    <svg
      aria-hidden="true"
      className="whiteboard-agent-logo whiteboard-agent-logo--cursor"
      focusable="false"
      viewBox="0 0 24 24"
    >
      <path
...
export function PiLogo(): ReactElement {
  return (
    <svg
      aria-hidden="true"
      className="whiteboard-agent-logo whiteboard-agent-logo--pi"
      focusable="false"
      viewBox="0 0 24 24"
    >
      <path
...
export function OpenCodeLogo(): ReactElement {
  return (
    <svg
      aria-hidden="true"
      className="whiteboard-agent-logo whiteboard-agent-logo--opencode"
      focusable="false"
      viewBox="0 0 24 24"
    >
      <path
