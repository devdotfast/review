...
import { IWhiteboardExplorerPartsService } from '../../browser/parts/explorer/whiteboardExplorerPart.js';
 ...
 * `setViewVisible` on `WhiteboardWorkbench.sideBarPartView`, which Review never
 ...
 */
class ToggleWhiteboardFileTreeAction extends Action2 {
	constructor() {
		super({
	...
	override run(accessor: ServicesAccessor): void {
		accessor.get(IWhiteboardExplorerPartsService).toggle();
	}
}

registerAction2(ToggleWhiteboardFileTreeAction);
