...
import { createSessionApi as createJsonWhiteboardApi } from "../session-api/http.js";
...
`,
    ...
    vi.stubEnv("WHITEBOARD_DIFFR_BINARY", executable);
    ...
    try {
      ...
      const app = createJsonWhiteboardApi(local.store, local.data);
