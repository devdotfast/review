...
class WhiteboardStatusbarService implements IStatusbarService {
...
class WhiteboardBannerService implements IBannerService {
	declare readonly _serviceBrand: undefined;
	focus(): void { }
 ...
 */
class WhiteboardQuickDiffModelService implements IQuickDiffModelService {
	declare readonly _serviceBrand: undefined;
 ...
 */
class WhiteboardExtensionsWorkbenchService implements IExtensionsWorkbenchService {
	declare readonly _serviceBrand: undefined;
...
registerSingleton(IStatusbarService, WhiteboardStatusbarService, InstantiationType.Eager);
registerSingleton(IBannerService, WhiteboardBannerService, InstantiationType.Eager);
registerSingleton(IExtensionsWorkbenchService, WhiteboardExtensionsWorkbenchService, InstantiationType.Eager);
registerSingleton(IQuickDiffModelService, WhiteboardQuickDiffModelService, InstantiationType.Eager);
