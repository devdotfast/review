...
export const REVIEW_AGENT_BRIDGE_URL_ENV = "DEV_FAST_REVIEW_AGENT_BRIDGE_URL";
export const REVIEW_AGENT_BRIDGE_TOKEN_ENV =
  "DEV_FAST_REVIEW_AGENT_BRIDGE_TOKEN";
export const REVIEW_AGENT_THREAD_TOKEN_ENV =
  "DEV_FAST_REVIEW_AGENT_THREAD_TOKEN";

/** Stable before any agent session exists; the desktop token authenticates reads. */
