...
import './whiteboardExtensionHostUnsupportedApiPeers.js';
...
class WhiteboardExtensionPoints implements IWorkbenchContribution {
...
registerWorkbenchContribution2(WhiteboardExtensionPoints.ID, WhiteboardExtensionPoints, WorkbenchPhase.BlockStartup);
