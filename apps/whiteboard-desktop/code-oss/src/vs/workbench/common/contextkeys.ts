...
export const IsWhiteboardWindowContext = new RawContextKey<boolean>('isWhiteboardWindow', false, localize('isWhiteboardWindow', "Whether the current window is a Review window."));
