...
const source = (text: string): SourceData => ({text, regions: [
  {kind: 'leaf', id: 1, fold_state_id: 1, alignment_id: 1, start: {line: 0, column: 0}, end: {line: 1, column: 0}, search_highlights: [{line: 0, start_column: 2, end_column: 6}]},
  {kind: 'fold', id: 2, fold_state_id: 2, start: {line: 1, column: 0}, end: {line: 2, column: 0}, visibility: {collapsed: true}, children: [
    {kind: 'leaf', id: 3, fold_state_id: 3, alignment_id: 3, start: {line: 1, column: 0}, end: {line: 2, column: 0}},
  ]},
]});
function result(): SearchResultData {
  return {kind: 'rhs', scope: {repo: '/unused', baseWorktree: {commitId: 'base', path: '/unused/base'}, headWorktree: {commitId: 'head', path: '/unused/head'}},
    file: {rhs: {path: 'example.ts', oid: 'a'.repeat(40), mode: '100644'}}, sources: {rhs: source('é🔎 match\nhidden\n')}};
}
