...
export async function run(ctx) {
  ...
  const editor = canvas
    .locator('[data-whiteboard-section="Welcome"] .whiteboard-inline-editor')
    .first();
  ...
  await canvas
    .locator('[data-whiteboard-section="Welcome"] a[data-whiteboard-anchor-id]')
    .first()
    .click();
  ...
  await page.locator(".whiteboard-commit-open").first().click();
  ...
  await canvas
    .locator('[data-whiteboard-section="Agent traces"] .whiteboard-trace-quote')
    .first()
    .click();
