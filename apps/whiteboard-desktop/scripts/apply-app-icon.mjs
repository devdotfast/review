...
//
// Usage: [WHITEBOARD_APP_ICON_CHANNEL=preview] node apply-app-icon.mjs <path-to .app>
//        [--icon-name NAME]
...
const ICON_VARIANT = getIconVariant(process.env.WHITEBOARD_APP_ICON_CHANNEL);
