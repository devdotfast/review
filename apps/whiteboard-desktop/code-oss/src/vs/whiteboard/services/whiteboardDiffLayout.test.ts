...
import type { WhiteboardDiffLayout } from "../common/whiteboardProtocol.js";
...
function createService() {
  ...
  const service = new WhiteboardDiffLayoutSetting(configurationService as never);
...
test("set writes the user setting and announces the new layout", async () => {
  ...
  const announced: WhiteboardDiffLayout[] = [];
