...
export const WHITEBOARD_DESKTOP_BACKGROUND_ENV = "DEV_FAST_WHITEBOARD_DESKTOP_BACKGROUND";
 ...
 */
export class WhiteboardBackgroundLaunch {
	private pending: boolean;
	private showInactiveOnCreate = false;

	constructor(env: NodeJS.ProcessEnv = process.env) {
		this.pending = env[WHITEBOARD_DESKTOP_BACKGROUND_ENV] === "1";
	}
...
export const whiteboardBackgroundLaunch = new WhiteboardBackgroundLaunch();
