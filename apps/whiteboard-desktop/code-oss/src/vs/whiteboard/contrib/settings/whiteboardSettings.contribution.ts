 ...
 */
class OpenWhiteboardSettingsAction extends Action2 {
	constructor() {
		super({
	...
	override async run(accessor: ServicesAccessor): Promise<void> {
		await accessor.get(IWhiteboardCanvasEditorTabsService).openSettings(true);
	}
}

registerAction2(OpenWhiteboardSettingsAction);
