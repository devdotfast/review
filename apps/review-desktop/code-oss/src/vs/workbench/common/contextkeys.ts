...
export const IsReviewWindowContext = new RawContextKey<boolean>('isReviewWindow', false, localize('isReviewWindow', "Whether the current window is a Review window."));
