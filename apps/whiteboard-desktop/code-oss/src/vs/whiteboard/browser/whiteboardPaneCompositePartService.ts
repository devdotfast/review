...
class WhiteboardPaneCompositePartService implements IPaneCompositePartService {
...
registerSingleton(IPaneCompositePartService, WhiteboardPaneCompositePartService, InstantiationType.Delayed);
