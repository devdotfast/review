...
describe("defineSoftwareModel", () => {
  ...
  it("normalizes C4 coverage claims for residual diff accounting", () => {
        ...
        progressiveReview: {
          coverage: {
            files: [
              ...
              {
                path: "packages/review/app/src/software-map/styles.css",
                ranges: [{ fromLine: 10, toLine: 20 }],
              },
            ],
            globs: ["packages/review/app/src/software-map/*.test.ts"],
          },
          containers: {
            reviewApp: {
              coverage: {
                files: ["packages/review/app/src/software-map/SoftwareMap.tsx"],
              },
            },
          },
        },
    ...
    expect(model.elementsByPath.get("progressiveReview")?.coverage).toEqual({
      files: [
        {
          path: "packages/review/skills/dev-review/SKILL.md",
          ranges: [],
        },
        {
          path: "packages/review/app/src/software-map/styles.css",
    ...
    expect(
      ...
      files: [
        {
          path: "packages/review/app/src/software-map/SoftwareMap.tsx",
          ranges: [],
        },
      ],
      globs: [],
