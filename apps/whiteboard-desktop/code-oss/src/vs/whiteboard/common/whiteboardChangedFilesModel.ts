import type { WhiteboardDiffFileWire } from "./whiteboardProtocol.js";
...
export function orderWhiteboardDiffFiles(
  files: readonly WhiteboardDiffFileWire[],
): readonly WhiteboardDiffFileWire[] {
  const ordered: WhiteboardDiffFileWire[] = [];
