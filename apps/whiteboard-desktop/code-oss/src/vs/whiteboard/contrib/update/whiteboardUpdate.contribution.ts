...
import {
	...
	type IWhiteboardStagedUpdate,
} from '../../common/whiteboardUpdateNotice.js';
...
class WhiteboardUpdateNotifications extends Disposable {
	...
	private showReadyNotification(next: IWhiteboardStagedUpdate): void {
 ...
 */
class WhiteboardCheckForUpdatesAction extends Action2 {
...
registerAction2(WhiteboardCheckForUpdatesAction);
registerWorkbenchContribution2(
	WhiteboardUpdateNotifications.ID,
	WhiteboardUpdateNotifications,
