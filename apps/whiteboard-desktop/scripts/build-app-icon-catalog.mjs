...
export const PWHITEBOARD_ICON_SOURCE = path.join(
  ICONS_DIR,
  "dev-fast-preview.icon",
);

export const PWHITEBOARD_CATALOG = path.join(ICONS_DIR, "Assets-preview.car");

export const PWHITEBOARD_SOURCE_DIGEST = path.join(
  ICONS_DIR,
  "Assets-preview.car.source-sha256",
);

export const PWHITEBOARD_FALLBACK = path.join(ICONS_DIR, "dev-fast-preview.icns");

export const PWHITEBOARD_ICON_NAME = "dev-fast-preview";
...
export const ICON_VARIANTS = Object.freeze({
  ...
  preview: Object.freeze({
    channel: "preview",
    iconSource: PWHITEBOARD_ICON_SOURCE,
    catalog: PWHITEBOARD_CATALOG,
    sourceDigest: PWHITEBOARD_SOURCE_DIGEST,
    fallback: PWHITEBOARD_FALLBACK,
    iconName: PWHITEBOARD_ICON_NAME,
  }),
});
