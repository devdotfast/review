...
export function blockedWhiteboardRequestReason(value) {
  let url;
...
export function assertNoBlockedWhiteboardRequests(requestUrls) {
  const blocked = [
    ...new Map(
      requestUrls.flatMap((url) => {
        const reason = blockedWhiteboardRequestReason(url);
