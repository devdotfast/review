...
describe("agent markdown", () => {
  ...
  it("renders local filesystem links as non-clickable code references", () => {
    const html = renderToStaticMarkup(
      createElement(AgentMarkdown, {
        source: [
          "[App.test.ts:49](/Users/ketanagrawal/monorepo/repos/dev/packages/whiteboard/app/src/App.test.ts:49)",
          "[styles.css](file:///Users/ketanagrawal/monorepo/repos/dev/packages/whiteboard/app/src/styles.css)",
        ].join("\n\n"),
      }),
    );
  ...
  it("highlights quote spans inside markdown paragraphs and inline code", () => {
    ...
    expect(html).toContain(
      '<mark class="whiteboard-trace-quote-mark">optimize database queries</mark>',
    );
  });
