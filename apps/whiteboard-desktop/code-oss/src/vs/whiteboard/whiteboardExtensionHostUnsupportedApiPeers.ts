...
export class WhiteboardMainThreadAuthentication {
...
export class WhiteboardMainThreadTerminalService {
	constructor(_context: IExtHostContext) { }
	dispose(): void { }
...
export class WhiteboardMainThreadTask {
	constructor(_context: IExtHostContext) { }
	dispose(): void { }
...
export class WhiteboardMainThreadLanguageModelTools {
	constructor(_context: IExtHostContext) { }
	dispose(): void { }
...
export class WhiteboardMainThreadUrls {
	constructor(_context: IExtHostContext) { }
	dispose(): void { }
