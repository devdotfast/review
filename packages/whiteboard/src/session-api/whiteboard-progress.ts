...
export interface WhiteboardProgress {
  complete?: boolean;
...
export async function whiteboardProgress(
  store: SessionStore,
  ...
  const lenses: WhiteboardProgress["lenses"] = await Promise.all(
