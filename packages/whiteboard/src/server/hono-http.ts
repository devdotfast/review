...
import { WHITEBOARD_APP_SESSION_ID_HEADER } from "../ui-telemetry-events";
...
export type WhiteboardHonoEnv = {
  Bindings: HttpBindings;
};

export function createNodeRequestListener(
  app: Hono<WhiteboardHonoEnv>,
...
export function applyCorsHeaders(
  ...
  response.headers.set(
    ...
    `content-type, x-whiteboard-token, ${WHITEBOARD_APP_SESSION_ID_HEADER}`,
  );
  response.headers.set(
