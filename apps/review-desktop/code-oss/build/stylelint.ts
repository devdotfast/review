 ...
 * design-system area (`src/vs/review`); used when the caller explicitly
...
export default function gulpstylelint(reporter: Reporter, designTokensEverywhere = false): NodeJS.ReadWriteStream {
	...
	const designSystemPattern = /^src[\/\\]vs[\/\\]review[\/\\]/;
	...
	return es.through(function (this, file: FileWithLines) {
		...
		// By default these are scoped to the design-system area (src/vs/review),
 ...
 * default `src/vs/review` scope to follow the requested path).
 */
