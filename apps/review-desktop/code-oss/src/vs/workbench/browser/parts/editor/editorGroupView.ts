...
export class EditorGroupView extends Themable implements IEditorGroupView {
	...
	private doStickEditor(candidate: EditorInput | undefined, sticky: boolean): void {
		if (!sticky && candidate?.hasCapability(EditorInputCapabilities.CannotClose)) {
			return; // an editor that cannot close relies on staying sticky (e.g. compact pinned rendering)
		}
