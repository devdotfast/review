...
import { extHostNamedCustomer, ExtHostCustomersRegistry, IExtHostContext, IInternalExtHostContext } from '../../services/extensions/common/extHostCustomers.js';
...
export class MainThreadExtensionService implements MainThreadExtensionServiceShape {
	...
	constructor(
		...
		internalExtHostContext._setAllMainProxyIdentifiers(
			ExtHostCustomersRegistry.getNamedCustomers().map(([identifier]) => identifier)
		);
	}
