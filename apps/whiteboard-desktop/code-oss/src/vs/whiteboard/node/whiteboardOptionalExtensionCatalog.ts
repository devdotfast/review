...
export const whiteboardOptionalExtensionCatalog = [
	{
...
export type WhiteboardOptionalExtension = (typeof whiteboardOptionalExtensionCatalog)[number];
export type WhiteboardOptionalExtensionTarget = keyof WhiteboardOptionalExtension['targets'];
