 ...
 */
export class WhiteboardDiffLayoutSetting extends Disposable {
  private readonly _onDidChange = this._register(
    new Emitter<WhiteboardDiffLayout>(),
  );
  ...
  set(layout: WhiteboardDiffLayout): Promise<void> {
