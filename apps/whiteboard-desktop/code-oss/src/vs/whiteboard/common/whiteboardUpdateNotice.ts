...
export interface IWhiteboardStagedUpdate {
...
export function serializeStagedUpdate(staged: IWhiteboardStagedUpdate): string {
 ...
 */
export function parseStagedUpdate(raw: string | undefined): IWhiteboardStagedUpdate | undefined {
	if (!raw) {
		return undefined;
	}
	let parsed: unknown;
 ...
 */
export function stagedUpdateFromReady(update: { version?: string; productVersion?: string } | undefined): IWhiteboardStagedUpdate | undefined {
	if (!update?.version) {
		return undefined;
	}
...
export type WhiteboardUpdateNotice =
...
export function decideUpdateNotice(
	staged: IWhiteboardStagedUpdate | undefined,
	currentCommit: string | undefined,
): WhiteboardUpdateNotice {
	if (!staged) {
		return { kind: 'none' };
	}
...
export function supersedesStagedUpdate(
	existing: IWhiteboardStagedUpdate | undefined,
	next: IWhiteboardStagedUpdate,
): boolean {
