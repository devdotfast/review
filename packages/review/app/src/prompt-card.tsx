...
export const PROMPTS: Record<PromptKind, string> = {
  change:
    "Use Review to review my current branch against up to date main, then open it in Review.",
  architecture:
    "Use Review to sketch out the main data flows, access patterns, and code paths in this repo, so I can do a full architecture review of it. Open it in Review when you're done.",
};
