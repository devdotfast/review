...
function userEvent(text: string): WhiteboardAgentTraceEvent {
  return { kind: "user", text };
}

function assistantEvent(markdown: string): WhiteboardAgentTraceEvent {
  return { kind: "assistant", markdown };
}

function toolEvent(title: string): WhiteboardAgentTraceEvent {
...
describe("turn ticks", () => {
  const events: WhiteboardAgentTraceEvent[] = [
    toolEvent("setup"),
    userEvent("can you help root cause this"),
    assistantEvent("I will isolate the break."),
    toolEvent("rg -n whiteboardUnifiedTargetForRange"),
...
describe("TraceRuler", () => {
  ...
  it("renders nothing for an empty trace", async () => {
    ...
    expect(container.querySelector(".whiteboard-trace-ruler")).toBe(null);
  });
  ...
  it("renders the ruler anchor for a populated trace", async () => {
    ...
    expect(container.querySelector(".whiteboard-trace-ruler")).not.toBe(null);
  });
});
