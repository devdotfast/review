...
import { appendWhiteboardInstallId } from '../../../../whiteboard/common/whiteboardAboutDialog.js';
import { WHITEBOARD_DESKTOP_CHANNEL, type WhiteboardDesktopConnection } from '../../../../whiteboard/common/whiteboardDesktopBootstrap.js';
		...
		while (this.model.dialogs.length) {
			...
			try {
				...
				// About
					...
					const [osProperties, connection] = await Promise.all([
					...
					const aboutDialogDetails = appendWhiteboardInstallId(
						createNativeAboutDialogDetails(this.productService, osProperties),
