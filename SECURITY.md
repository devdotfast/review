...
`apps/review-desktop/code-oss/` applies to Microsoft's VS Code project.

If an issue originates in Code - OSS, report it to Microsoft and to us when it
also affects Whiteboard.
